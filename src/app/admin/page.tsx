        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            <div>
              ...
              <div className="font-bold text-sm text-slate-900 group-hover:text-purple-600 transition">
                Temp Mail Control
              </div>
          ...
          >
            <div>
              ...
              <div className="font-bold text-sm text-slate-900 group-hover:text-rose-600 transition">
                System Health
              </div>
